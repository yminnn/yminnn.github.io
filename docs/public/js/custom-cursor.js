document.addEventListener('DOMContentLoaded', function() {
  ...
  function getNextChimeNote() {
    ...
    // 根据主题选择不同的音阶
    const winterChimesScale = currentTheme === 'light' ? [
      // Light theme: G#-B-C#-E-G#-E-A-C#
      415.30 * 1.2, // G#4
      493.88 * 1.2, // B4
      277.18 * 1.2, // C#4
      329.63 * 1.2, // E4
      ...
      // Dark theme: Original scale (D-F-A-B-C-E-A#-C)
      293.66 * 1.2, // D4
      349.23 * 1.2, // F4
      440.00 * 1.2, // A4
      493.88 * 1.2, // B4
    ...
    // 风铃和弦 - 根据主题选择不同的和弦
    const winterChords = currentTheme === 'light' ? [
      [415.30 * 1.2, 493.88 * 1.2, 277.18 * 1.2], // G#-B-C# 和弦
      [329.63 * 1.2, 415.30 * 1.2, 440.00 * 1.2], // E-G#-A 和弦
      [277.18 * 1.2, 329.63 * 1.2, 415.30 * 1.2], // C#-E-G# 和弦
      [440.00 * 1.2, 493.88 * 1.2, 329.63 * 1.2], // A-B-E 和弦
      [415.30 * 1.2, 277.18 * 1.2, 440.00 * 1.2]  // G#-C#-A 和弦
    ] : [
      [293.66 * 1.2, 440.00 * 1.2, 523.25 * 1.2], // D-A-C 和弦
      [349.23 * 1.2, 440.00 * 1.2, 523.25 * 1.2], // F-A-C 和弦
      [440.00 * 1.2, 523.25 * 1.2, 659.26 * 1.2], // A-C-E 和弦
      [293.66 * 1.2, 349.23 * 1.2, 440.00 * 1.2], // D-F-A 和弦
      [349.23 * 1.2, 466.16 * 1.2, 587.33 * 1.2]  // F-Bb-D 和弦
    ];
